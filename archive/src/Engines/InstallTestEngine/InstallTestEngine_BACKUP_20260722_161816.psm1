...
function Start-InstallationTest {
    ...
    try {
        ...
        if ($UserContext) {
            ...
            Write-Verbose "InstallTestEngine: Using standard mode"
        }
        
        # Launch Install.exe and wait for completion - SIMPLE!
        $installProcess = Start-Process -FilePath $InstallExePath -ArgumentList $arguments -PassThru -Wait
...
function Start-UninstallationTest {
    ...
    try {
        ...
        # Launch Install.exe /uninstall and wait - SIMPLE!
